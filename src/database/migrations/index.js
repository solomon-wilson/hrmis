...
class MigrationRunner {
     ...
     */
    async initializeMigrationsTable(client) {
     ...
     */
    async removeMigrationRecord(client, migrationId) {
    ...
    async loadMigrations() {
        ...
        migrations.push(createUsersTable, createRolesTable, createUserRolesTable, createDepartmentsTable, createEmployeesTable, createEmployeeStatusHistoryTable, createAuditLogsTable, {
            id: '008',
