...
export class PermissionManager {
  ...
  private readonly rolePermissions: Record<UserRole, Record<Resource, Action[]>> = {
    'VIEWER': {
      employee: ['read', 'list'],
   ...
   */
  canAccessEmployee(context: PermissionContext, targetEmployeeId: string): boolean {
   ...
   */
  canModifyEmployee(context: PermissionContext, targetEmployeeId: string): boolean {
   ...
   */
  canManageEmployeeStatus(context: PermissionContext, targetEmployeeId: string): boolean {
   ...
   */
  getHighestRoleLevel(roles: UserRole[]): number {
   ...
   */
  hasRole(roles: UserRole[], targetRole: UserRole): boolean {
   ...
   */
  hasRoleLevel(roles: UserRole[], minimumRole: UserRole): boolean {
   ...
   */
  private getBaseFieldPermissions(roles: UserRole[], resource: Resource): FieldPermissions {
   ...
   */
  private applyFieldContextualRules(
    basePermissions: FieldPermissions,
    context: PermissionContext,
    resource: Resource,
    targetId?: string
  ): FieldPermissions {
