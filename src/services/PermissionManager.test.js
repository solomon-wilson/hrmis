...
describe('PermissionManager', () => {
    ...
    const createContext = (roles, overrides = {}) => ({
        userId: 'user-123',
        roles,
        employeeId: 'emp-123',
        ...overrides
    ...
    describe('Data Filtering', () => {
        describe('filterSensitiveFields', () => {
            ...
            it('should return all fields for HR_ADMIN', () => {
                const context = createContext(['HR_ADMIN']);
                const filtered = permissionManager.filterSensitiveFields(sampleEmployeeData, context, 'employee');
            ...
            it('should handle empty or null data gracefully', () => {
                ...
                expect(permissionManager.filterSensitiveFields(null, context, 'employee')).toEqual({});
            });
        });
    });
    ...
    describe('Error Handling', () => {
        it('should handle invalid roles gracefully', () => {
            const context = createContext(['INVALID_ROLE']);
            expect(permissionManager.hasPermission(context, 'employee', 'read')).toBe(false);
            expect(permissionManager.getHighestRoleLevel(['INVALID_ROLE'])).toBe(0);
        });
