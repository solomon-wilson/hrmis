 ...
 */
export const documentAuditMiddleware = (action, entityType = 'DOCUMENT') => {
 ...
 */
export const leavePlanAuditMiddleware = (action) => documentAuditMiddleware(action, 'LEAVE_PLAN');
/**
 * Security event audit middleware for unauthorized access attempts
 */
export const securityEventAuditMiddleware = async (req, res, next) => {
 ...
 */
async function logDocumentAudit({ req, action, entityType, responseData, duration, statusCode }) {
    try {
 ...
 * Log security events
 */
async function logSecurityEvent({ req, statusCode, reason }) {
    try {
        const auditLog = {
 ...
 */
export const addAuditContext = (entityType, action, getEntityId, getDetails) => {
    return (req, res, next) => {
        req.auditContext = {
            entityType,
            action,
 ...
 */
export const logDocumentOperation = async (userId, entityType, entityId, action, details, employeeId) => {
    try {
        const auditLog = {
            entity_type: entityType,
            entity_id: entityId,
