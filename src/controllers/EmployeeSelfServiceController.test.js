...
describe('EmployeeSelfServiceController Integration Tests', () => {
    ...
    describe('GET /api/employees/me', () => {
        it('should return current user employee profile', async () => {
            ...
            expect(mockEmployeeService.getEmployee).toHaveBeenCalledWith(mockUser.employeeId, expect.objectContaining({
                userId: mockUser.id,
                role: 'EMPLOYEE'
            }));
        });
    ...
    describe('PUT /api/employees/me', () => {
        it('should update employee profile with allowed fields', async () => {
            ...
            expect(mockEmployeeService.updateEmployee).toHaveBeenCalledWith(mockUser.employeeId, expect.objectContaining({
