...
jest.mock('../middleware/auth', () => ({
  ...
  canAccessEmployee: jest.fn((_req: any, _res: any, next: any) => next()),
  canModifyEmployee: jest.fn((_req: any, _res: any, next: any) => next()),
  filterEmployeeFields: jest.fn((_req: any, _res: any, next: any) => next())
}));
...
describe('EmployeeController Integration Tests', () => {
  ...
  beforeEach(() => {
    ...
    (EmployeeService as any).mockImplementation(() => mockEmployeeService);
  ...
  describe('DELETE /api/employees/:id', () => {
    ...
    it('should terminate employee (soft delete)', async () => {
      ...
      expect(mockEmployeeService.updateEmployeeStatus).toHaveBeenCalledWith(
        mockEmployee.id,
        'TERMINATED',
        expect.any(Date),
  ...
  describe('GET /api/employees/:id/history', () => {
    it('should return employee status history', async () => {
      ...
      expect(mockEmployeeService.getEmployeeStatusHistory).toHaveBeenCalledWith(
        mockEmployee.id,
        expect.any(Object)
      );
    });
  ...
  describe('Error Handling', () => {
    it('should handle service errors gracefully', async () => {
      mockEmployeeService.searchEmployees = jest.fn().mockRejectedValue(
    ...
    it('should handle authentication errors', async () => {
      mockAuthService.validateSession = jest.fn().mockRejectedValue(
    ...
    it('should handle permission errors', async () => {
      mockEmployeeService.getEmployee = jest.fn().mockRejectedValue(
        new Error('Insufficient permissions to view this employee')
      );
