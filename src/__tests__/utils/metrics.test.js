import { metricsCollector, recordHttpRequest, recordDatabaseQuery, PerformanceTimer } from '../../utils/metrics';
describe('Metrics System', () => {
    ...
    describe('Database Query Metrics', () => {
        it('should record database query metrics', () => {
            recordDatabaseQuery('SELECT * FROM employees WHERE id = $1', 'SELECT', 50, true, {
                rowsAffected: 1,
        ...
        it('should record failed query metrics', () => {
            recordDatabaseQuery('INSERT INTO employees VALUES ($1, $2)', 'INSERT', 100, false, {
