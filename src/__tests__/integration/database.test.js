    ...
    describe('Database Transaction Handling', () => {
        test('should rollback transaction on error', async () => {
            ...
            try {
                ...
                // Create an employee
                await client.query(`INSERT INTO employees (id, employee_id, first_name, last_name, email, job_title, department, start_date, employment_type, status, created_at, updated_at, created_by, updated_by)
           VALUES (gen_random_uuid(), $1, $2, $3, $4, $5, $6, $7, $8, $9, NOW(), NOW(), $10, $10)`, ['TRANS001', 'Transaction', 'Test', 'trans@test.com', 'Test Engineer', 'Engineering', '2024-01-01', 'FULL_TIME', 'ACTIVE', 'test-user']);
                // Intentionally cause an error (duplicate email)
                await client.query(`INSERT INTO employees (id, employee_id, first_name, last_name, email, job_title, department, start_date, employment_type, status, created_at, updated_at, created_by, updated_by)
           VALUES (gen_random_uuid(), $1, $2, $3, $4, $5, $6, $7, $8, $9, NOW(), NOW(), $10, $10)`, ['TRANS002', 'Transaction2', 'Test', 'trans@test.com', 'Test Engineer', 'Engineering', '2024-01-01', 'FULL_TIME', 'ACTIVE', 'test-user']);
