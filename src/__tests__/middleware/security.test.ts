...
describe('Security Middleware', () => {
  ...
  describe('pathTraversalProtection', () => {
    it('should allow safe paths', () => {
      (mockRequest as any).path = '/api/users/123';
      mockRequest.query = { file: 'document.pdf' };

      pathTraversalProtection(mockRequest as Request, mockResponse as Response, mockNext);

      expect(mockNext).toHaveBeenCalledWith();
    });

    it('should block path traversal in URL path', () => {
      (mockRequest as any).path = '/api/files/../../../etc/passwd';
  ...
  describe('httpMethodValidation', () => {
    ...
    it('should block invalid HTTP methods', () => {
      (mockRequest as any).method = 'TRACE';
  ...
  describe('userAgentValidation', () => {
    it('should allow valid user agents', () => {
      ...
      userAgentValidation(mockRequest as Request, mockResponse as Response, mockNext);
