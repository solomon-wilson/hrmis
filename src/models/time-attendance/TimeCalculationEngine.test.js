import { TimeCalculationEngine } from './TimeCalculationEngine';
...
describe('TimeCalculationEngine', () => {
    ...
    const createTimeEntry = (clockInTime, clockOutTime, breakEntries = []) => {
        const timeEntryData = {
    ...
    describe('calculateTimeEntryHours', () => {
        ...
        it('should calculate regular hours correctly for 8-hour day', () => {
            const timeEntry = createTimeEntry(new Date('2024-01-15T09:00:00Z'), new Date('2024-01-15T17:00:00Z'));
        ...
        it('should calculate overtime hours for 10-hour day', () => {
            const timeEntry = createTimeEntry(new Date('2024-01-15T09:00:00Z'), new Date('2024-01-15T19:00:00Z'));
            const result = engine.calculateTimeEntryHours(timeEntry);
        ...
        it('should calculate double time hours for 14-hour day', () => {
            const timeEntry = createTimeEntry(new Date('2024-01-15T09:00:00Z'), new Date('2024-01-15T23:00:00Z'));
            const result = engine.calculateTimeEntryHours(timeEntry);
        ...
        it('should deduct unpaid break time from total hours', () => {
            ...
            const timeEntry = createTimeEntry(new Date('2024-01-15T09:00:00Z'), new Date('2024-01-15T18:00:00Z'), // 9 hours total
            [unpaidLunchBreak]);
            const result = engine.calculateTimeEntryHours(timeEntry);
        ...
        it('should not deduct paid break time from total hours', () => {
            ...
            const timeEntry = createTimeEntry(new Date('2024-01-15T09:00:00Z'), new Date('2024-01-15T17:00:00Z'), // 8 hours total
            [paidBreak]);
            const result = engine.calculateTimeEntryHours(timeEntry);
    ...
    describe('calculateDailyHours', () => {
        it('should calculate daily totals for multiple time entries', () => {
            const entry1 = createTimeEntry(new Date('2024-01-15T09:00:00Z'), new Date('2024-01-15T13:00:00Z'));
            const entry2 = createTimeEntry(new Date('2024-01-15T14:00:00Z'), new Date('2024-01-15T18:00:00Z'));
        ...
        it('should apply daily overtime rules to combined entries', () => {
            const entry1 = createTimeEntry(new Date('2024-01-15T09:00:00Z'), new Date('2024-01-15T14:00:00Z') // 5 hours
            );
            const entry2 = createTimeEntry(new Date('2024-01-15T15:00:00Z'), new Date('2024-01-15T21:00:00Z') // 6 hours
            );
            const timeEntries = [entry1, entry2];
            const date = new Date('2024-01-15');
            const result = engine.calculateDailyHours(timeEntries, date);
        ...
        it('should filter entries for the correct date', () => {
            const entry1 = createTimeEntry(new Date('2024-01-15T09:00:00Z'), new Date('2024-01-15T17:00:00Z'));
            const entry2 = createTimeEntry(new Date('2024-01-16T09:00:00Z'), // Different day
    ...
    describe('calculateWeeklyHours', () => {
        it('should calculate weekly totals for multiple days', () => {
            const mondayEntry = createTimeEntry(new Date('2024-01-15T09:00:00Z'), // Monday
            new Date('2024-01-15T17:00:00Z'));
            const tuesdayEntry = createTimeEntry(new Date('2024-01-16T09:00:00Z'), // Tuesday
            new Date('2024-01-16T17:00:00Z'));
    ...
    describe('detectOvertime', () => {
        it('should detect daily overtime', () => {
            const timeEntry = createTimeEntry(new Date('2024-01-15T09:00:00Z'), new Date('2024-01-15T19:00:00Z') // 10 hours
            );
    ...
    describe('edge cases', () => {
        it('should handle entries spanning midnight', () => {
            const timeEntry = createTimeEntry(new Date('2024-01-15T23:00:00Z'), new Date('2024-01-16T07:00:00Z') // 8 hours spanning midnight
            );
            const result = engine.calculateTimeEntryHours(timeEntry);
            expect(result.totalHours).toBe(8);
            expect(result.regularHours).toBe(8);
        ...
        it('should handle very short time entries', () => {
            const timeEntry = createTimeEntry(new Date('2024-01-15T09:00:00Z'), new Date('2024-01-15T09:15:00Z') // 15 minutes
            );
            const result = engine.calculateTimeEntryHours(timeEntry);
        ...
        it('should handle custom overtime rules with no double time', () => {
            ...
            const customEngine = new TimeCalculationEngine(customRules);
            const timeEntry = createTimeEntry(new Date('2024-01-15T09:00:00Z'), new Date('2024-01-15T23:00:00Z') // 14 hours
            );
