...
export class EmployeeTimeStatus {
     ...
     */
    hasIncompleteTimeEntry(maxHoursWithoutBreak = 12) {
     ...
     */
    hasLongBreak(maxBreakMinutes = 120) {
     ...
     */
    forceStatusChange(newStatus, activeTimeEntryId, activeBreakEntryId) {
        const updateData = {
