import { EmployeeTimeStatus, EmployeeTimeStatusData } from './EmployeeTimeStatus';
...
describe('EmployeeTimeStatus', () => {
  ...
  const validClockedOutData: EmployeeTimeStatusData = {
  ...
  const validClockedInData: EmployeeTimeStatusData = {
    employeeId: validEmployeeId,
  ...
  const validOnBreakData: EmployeeTimeStatusData = {
    employeeId: validEmployeeId,
