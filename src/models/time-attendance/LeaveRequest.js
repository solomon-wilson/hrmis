...
export class LeaveRequest {
    ...
    validateAdvanceNotice(requiredDays) {
    ...
    validateMaxConsecutiveDays(maxDays) {
    ...
    static createNew(employeeId, leaveTypeId, startDate, endDate, totalDays, totalHours, reason) {
        return new LeaveRequest({
            employeeId,
            leaveTypeId,
            startDate,
