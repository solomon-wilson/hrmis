import { EmployeeStatusHistory, EmployeeStatusHistoryData, EmployeeStatusType } from './EmployeeStatusHistory';
...
describe('EmployeeStatusHistory Model', () => {
  ...
  const validStatusHistoryData: EmployeeStatusHistoryData = {
    employeeId,
  ...
  describe('Constructor and Validation', () => {
    ...
    it('should create a valid status history with only required fields', () => {
      const minimalData: EmployeeStatusHistoryData = {
        employeeId,
        newStatus: 'ACTIVE',
        effectiveDate,
        changedBy
    ...
    it('should trim reason and notes', () => {
      const dataWithWhitespace: EmployeeStatusHistoryData = {
        employeeId,
    ...
    it('should throw ValidationError for missing required fields', () => {
      const invalidData = { employeeId, newStatus: 'ACTIVE' } as EmployeeStatusHistoryData;
    ...
    it('should throw ValidationError for invalid status type', () => {
      const invalidData = {
        ...
        newStatus: 'INVALID_STATUS' as EmployeeStatusType
      };
      expect(() => new EmployeeStatusHistory(invalidData)).toThrow(ValidationError);
    });
    ...
    it('should throw ValidationError for reason exceeding max length', () => {
      ...
      const invalidData = {
        ...validStatusHistoryData,
        newStatus: 'TERMINATED' as EmployeeStatusType,
        reason: longReason
      };
      expect(() => new EmployeeStatusHistory(invalidData)).toThrow(ValidationError);
    });
  ...
  describe('Business Rule Validation', () => {
    it('should throw ValidationError for terminated status without reason', () => {
      const invalidData: EmployeeStatusHistoryData = {
        employeeId,
        previousStatus: 'ACTIVE',
        newStatus: 'TERMINATED',
        effectiveDate,
    ...
    it('should accept terminated status with reason', () => {
      const validData: EmployeeStatusHistoryData = {
        employeeId,
        previousStatus: 'ACTIVE',
        newStatus: 'TERMINATED',
        effectiveDate,
  ...
  describe('Static Factory Methods', () => {
    it('should create initial status with createInitialStatus', () => {
      const initialStatus = EmployeeStatusHistory.createInitialStatus(
        employeeId,
        'ACTIVE',
        effectiveDate,
        changedBy
    ...
    it('should create status change with createStatusChange', () => {
      const statusChange = EmployeeStatusHistory.createStatusChange(
        employeeId,
        'ACTIVE',
        'ON_LEAVE',
        effectiveDate,
    ...
    it('should create termination with createTermination', () => {
      const termination = EmployeeStatusHistory.createTermination(
        employeeId,
        'ACTIVE',
        'End of probation',
        effectiveDate,
    ...
    it('should create leave with createLeave', () => {
      const leave = EmployeeStatusHistory.createLeave(
        employeeId,
        'ACTIVE',
        'Maternity leave',
        effectiveDate,
        changedBy,
        'Expected return date: 2024-01-15'
      );
