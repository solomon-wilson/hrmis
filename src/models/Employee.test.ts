...
import { JobInfoData, EmploymentType } from './JobInfo';
import { EmployeeStatusData } from './EmployeeStatus';
import { ValidationError } from '../utils/validation';

describe('Employee Model', () => {
  const validPersonalInfo: PersonalInfoData = {
    firstName: 'John',
    lastName: 'Doe',
  ...
  const validJobInfo: JobInfoData = {
  ...
  const validStatus: EmployeeStatusData = {
    current: 'ACTIVE',
  ...
  describe('Constructor and Validation', () => {
    ...
    it('should throw ValidationError for missing required fields', () => {
      ...
      delete (invalidData as any).employeeId;
      expect(() => new Employee(invalidData)).toThrow(ValidationError);
    });
  ...
  describe('Business Rule Validation', () => {
    ...
    it('should throw ValidationError for terminated status without reason', () => {
      const invalidStatus: EmployeeStatusData = {
        current: 'TERMINATED',
    ...
    it('should accept terminated status with reason', () => {
      const validTerminatedStatus: EmployeeStatusData = {
        current: 'TERMINATED',
        effectiveDate: new Date(),
    ...
    it('should accept on leave status with reason', () => {
      const validLeaveStatus: EmployeeStatusData = {
        current: 'ON_LEAVE',
        effectiveDate: new Date(),
  ...
  describe('Update Methods', () => {
    ...
    it('should update status', () => {
      const newStatus: EmployeeStatusData = {
        current: 'ON_LEAVE',
        effectiveDate: new Date(),
  ...
  describe('Helper Methods', () => {
    ...
    it('should check if employee is terminated', () => {
      ...
      const terminatedStatus: EmployeeStatusData = {
        current: 'TERMINATED',
        effectiveDate: new Date(),
        reason: 'Resignation'
      };
    ...
    it('should check if employee is on leave', () => {
      ...
      const leaveStatus: EmployeeStatusData = {
        current: 'ON_LEAVE',
        effectiveDate: new Date(),
        reason: 'Sick leave'
      };
  ...
  describe('Validation Methods', () => {
    ...
    it('should throw ValidationError for creation without email', () => {
      ...
      delete (personalInfoWithoutEmail as any).email;
